  ...
  return (
    <div className="border-l-4 border-blue-500 pl-4 ml-2 mb-4">
      ...
      {expanded && event.errors && (
        <div className="bg-gray-100 border rounded p-3 mt-2 text-sm text-gray-700">
      ...
      {expanded && event.teams_logs && (
        <div className="bg-gray-100 border rounded p-3 mt-2 text-sm text-gray-700 space-y-1">
